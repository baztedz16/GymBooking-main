...
public class DietAdapter extends RecyclerView.Adapter<DietAdapter.ViewHolder> {
    ...
    @NotNull
    @Override
    public DietAdapter.ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.program_diet_item,parent,false);
        DietAdapter.ViewHolder viewHolder = new DietAdapter.ViewHolder(view);
        return viewHolder;
    }
