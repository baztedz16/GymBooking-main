...
public class CoachesBookingListAdapter extends RecyclerView.Adapter<CoachesBookingListAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public CoachesBookingListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.list_of_profiles_bookingitem,parent,false);
        CoachesBookingListAdapter.ViewHolder viewHolder = new CoachesBookingListAdapter.ViewHolder(view);
        return viewHolder;
    }
