package com.domzky.gymbooking.Sessions.GymOwner.pages.StaffsList.AddStaff.StaffsList.ModifyStaff;
...
public class ModifyStaffActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reset_uid = intentGym.getStringExtra("staffuid");
        reset_gymid = intentGym.getStringExtra("gymuid");
        reset_fullname = intentGym.getStringExtra("stafffullname");
        reset_fullname = intentGym.getStringExtra("stafffullname");
        reset_email = intentGym.getStringExtra("staffemail");
        reset_phoneNum = intentGym.getStringExtra("staffphone");
        reset_username = intentGym.getStringExtra("staffusername");
        reset_password = intentGym.getStringExtra("staffpassword");
        reset_activated = intentGym.getBooleanExtra("staffactivated",true);
        
        preferences = this.getSharedPreferences("owner",MODE_PRIVATE);

        progress = new ProgressDialog(ModifyStaffActivity.this);
        ...
        banner.setText("MODIFYING STAFF FORM");
        ...
        signupBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checkIfAllChanged()) {
                    Toast.makeText(ModifyStaffActivity.this,"No Changes have been made.",Toast.LENGTH_SHORT).show();
                    progress.dismiss();
                    return;
                }
                            ...
                            fwrite.child(reset_uid).setValue(new GymStaff(fullname,email,phone,username,password,activated,preferences.getString("userid","")))
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            Toast.makeText(getApplicationContext(),"Staff Info Changed Successfully",Toast.LENGTH_LONG).show();
                                            finish();
                                        }
                                    })
                                    .addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(getApplicationContext(),"Staff Info Changed FAILED!!!",Toast.LENGTH_SHORT).show();
